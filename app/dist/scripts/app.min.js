...
{console.log(2);contactButton.addClass('on');var keepData=angular.copy($scope.data);keepData.contact=true;$http.post('/postDiagnostic',keepData).success(function(a,b){isSend.removeClass('hidden');contactButton.removeClass('on');}).error(function(a,b){isSend.removeClass('hidden');contactButton.removeClass('on');});}};});app.controller('formCtrl',function($scope,$timeout,$stateParams,$http,$state){$scope.values=[{id:1,label:'Agriculture',subItem:{name:"L'agriculture",response:"agriculture"}},{id:2,label:'Services',subItem:{name:'Le service',response:"service"}},{id:3,label:'Industrie',subItem:{name:"L'Industrie",response:"industrie"}},{id:4,label:'Bâtiment',subItem:{name:'Le bâtiment',response:"bâtiment"}},{id:5,label:'Média / Edition',subItem:{name:"Les Média et l'edition",response:"edition"}},{id:6,label:'Transport',subItem:{name:'Le transport',response:"transport"}},{id:7,label:'Télécom',subItem:{name:'Les télécoms',response:"télécom"}},{id:8,label:'Ecologie',subItem:{name:"L'ecologie",response:"ecologie"}},{id:9,label:'E-commerce',subItem:{name:"L'e-commerce",response:"e-commerce"}}];$scope.data={sector:"",email:"",fname:"",lname:"",phone:"",company:""};if($stateParams.id)
