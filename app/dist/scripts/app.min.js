...
{$scope.step=number;updateBar();updateNav();}};$scope.next=function(form){console.log($scope.data);if(!form.$invalid){$scope.step++;if($scope.maxStep<$scope.step)
{$scope.maxStep++;}
updateBar();updateNav();}};});